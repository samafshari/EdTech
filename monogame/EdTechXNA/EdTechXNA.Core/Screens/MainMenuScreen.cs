...
using EdTechXNA.Core;
using EdTechXNA.Core.Effects;
using EdTechXNA.Core.Inputs;
...
class MainMenuScreen : MenuScreen
{
    ...
    private void SetLanguageText()
    {
        ...
        Title = "EdTechXNA"; // TODO uncomment this if you want it to use Resources.MainMenu; instead
    }
    ...
    public override void LoadContent()
    {
        ...
        settingsManager ??= ScreenManager.Game.Services.GetService<SettingsManager<EdTechXNASettings>>();
