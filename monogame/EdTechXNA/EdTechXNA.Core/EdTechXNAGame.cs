...
using EdTechXNA.Core.Effects;
using EdTechXNA.Core.Localization;
using EdTechXNA.Core.Settings;
using EdTechXNA.ScreenManagers;
using EdTechXNA.Screens;
using Microsoft.Xna.Framework;
using Microsoft.Xna.Framework.Graphics;

namespace EdTechXNA.Core
{
    /// <summary>
    ...
    /// </remarks>}
    public class EdTechXNAGame : Game
    {
        ...
        private SettingsManager<EdTechXNASettings> settingsManager;

        // Manages leaderboard data for tracking high scores and achievements.
        private SettingsManager<EdTechXNALeaderboard> leaderboardManager;
        ...
        public EdTechXNAGame()
        {
            ...
            settingsManager = new SettingsManager<EdTechXNASettings>(storage);
            Services.AddService(typeof(SettingsManager<EdTechXNASettings>), settingsManager);

            leaderboardManager = new SettingsManager<EdTechXNALeaderboard>(storage);
            Services.AddService(typeof(SettingsManager<EdTechXNALeaderboard>), leaderboardManager);
